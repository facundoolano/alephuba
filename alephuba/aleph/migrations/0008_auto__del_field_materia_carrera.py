...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Materia.carrera'
        db.delete_column('aleph_materia', 'carrera_id')

        # Adding M2M table for field carrera on 'Materia'
        db.create_table('aleph_materia_carrera', (
        ...
        db.create_unique('aleph_materia_carrera', ['materia_id', 'carrera_id'])


    def backwards(self, orm):
        
        # Adding field 'Materia.carrera'
        db.add_column('aleph_materia', 'carrera', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aleph.Carrera'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field carrera on 'Materia'
        db.delete_table('aleph_materia_carrera')
