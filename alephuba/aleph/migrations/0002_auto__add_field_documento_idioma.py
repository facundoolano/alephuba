...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Documento.idioma'
        db.add_column('aleph_documento', 'idioma', self.gf('django.db.models.fields.CharField')(default='ES', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Documento.idioma'
        db.delete_column('aleph_documento', 'idioma')
