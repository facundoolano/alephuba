...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Materia.detalles'
        db.delete_column('aleph_materia', 'detalles')

        # Deleting field 'Carrera.detalles'
        db.delete_column('aleph_carrera', 'detalles')


    def backwards(self, orm):
        
        # Adding field 'Materia.detalles'
        db.add_column('aleph_materia', 'detalles', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Carrera.detalles'
        db.add_column('aleph_carrera', 'detalles', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
