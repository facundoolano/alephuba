...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Archivo.detalles'
        db.delete_column('aleph_archivo', 'detalles')


    def backwards(self, orm):
        
        # Adding field 'Archivo.detalles'
        db.add_column('aleph_archivo', 'detalles', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
