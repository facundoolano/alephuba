...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Materia.departamento'
        db.add_column('aleph_materia', 'departamento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aleph.Departamento'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Materia.departamento'
        db.delete_column('aleph_materia', 'departamento_id')
